...
\begin{solution}[a]
    ...
    \(S \Rightarrow_{G_1} bV \Rightarrow_{G_1} bvbS \Rightarrow_{G_1} bcbaaU \Rightarrow_{G_1} bcbaacU \Rightarrow_{G_1} bcbaacc \)

\end{solution}

\begin{solution}[b]

    \( L(G_1) = \{ x^{n}y | n \in \mathbb{N} \text{ mit } x = \{bca^{m}b | m \in \{0,1\}\} \text{ und } y = \{aavc | v \in \{b,c\}^{*}\} \} \)
...
\begin{solution}[d]
    ...
    \( L(G_2) = \{ cb^{2n}(ab)^{m}b^{2o}c(aa)^{n+o}a^{m} | n,m,o \in \mathbb{N} \} \)

    oder

    \( L(G_2) = \{ c(bb)^{n}(ab)^{m}(bb)^{o}ca^{2+(n+o)+m} | n,m,o \in \mathbb{N} \} \)
...
\begin{solution}[c]
    ...
    \( L(M_3) = \{ w \in c^{n}bc^{m} | n,m \in \mathbb{N} \text{ und } |w| > 0 \} \)
    
\end{solution}

\begin{solution}[d]

    \( L(M_4) = \{ x^{p}ab^{n}c^{m}b^{o} | m,n,o \in \mathbb{N} \text{ und } m \mod 2 = 1 \land p = \{0,1\}  \text{ mit } x = cb^{q} | q \in \mathbb{N} \}\)
