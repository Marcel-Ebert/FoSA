...
\begin{solution}[a]
    ...
    \( (\exists x . P_1(x)) \rightarrow \lnot(\forall y . P_2(y) \land P_3(y))) \)


    Def: de Morgen 1 
    \( (\exists x . P_1(x)) \rightarrow (\exists y . \lnot P_2(y) \lor \lnot P_3(y))) \)
...
\begin{solution}[b]
    ...
    Widerspruchs Annahme: \( \lnot(\exists x . P_1(c)) \land \lnot ((\forall y . P_2(y) \land P_3(y))) \)
